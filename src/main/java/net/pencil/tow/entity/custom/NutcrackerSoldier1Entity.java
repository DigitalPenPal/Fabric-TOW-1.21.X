...
public class NutcrackerSoldier1Entity extends HostileEntity {
    ...
    protected void pushAway(Entity entity) {
        ...
        if (entity instanceof Monster && (entity instanceof GolemEntity) && (entity instanceof HostileEntity) &&
                !(entity instanceof NutcrackerSoldier1Entity) && this.getRandom().nextInt(20) == 0){
